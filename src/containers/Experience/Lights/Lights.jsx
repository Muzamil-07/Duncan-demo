...
const Lights = () => {
  ...
  return (
    <>
      {/* FRONT */}
      {/* <directionalLight ref={dirLight1} position={[0, 0, 4]} intensity={1.2} /> */}
      {/* BACK */}
      {/* <directionalLight ref={dirLight2} position={[0, 0, -4]} intensity={1.2} /> */}
      {/* TOP */}
      <directionalLight
        ref={dirLight3}
        castShadow
      ...
      /> */}
      {/* RIGHT */}
      {/* <directionalLight ref={dirLight5} position={[4, 1, 0]} intensity={1.2} /> */}
      {/* LEFT */}
      {/* <directionalLight ref={dirLight6} position={[-4, 1, 0]} intensity={1.2} />
